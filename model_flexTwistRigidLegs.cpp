 ...
 * It also includes "rigid" legs that offset the cat's center of
 * mass.
 * */

class FlexTwistRigidLegsModeling : public FelisCatusModeling
{
    void addJoints();
    void addActuators();
};
...
{
    FlexTwistRigidLegsModeling m = FlexTwistRigidLegsModeling();
    m.makeModel("Leland_flexTwistRigidLegs",
            "feliscatus_flexTwistRigidLegs.osim");

    return EXIT_SUCCESS;
};

void FlexTwistRigidLegsModeling::addJoints()
{
...
void FlexTwistRigidLegsModeling::addActuators()
{
