...
class FlexRetractLegsModeling : public FelisCatusModeling
{
    void addJoints();
    void addActuators();
};
...
{
    FlexRetractLegsModeling m = FlexRetractLegsModeling();
    m.makeModel("Leland_flexRetractLegs",
            "feliscatus_flexRetractLegs.osim");

    return EXIT_SUCCESS;
};

void FlexRetractLegsModeling::addJoints()
{
...
void FlexRetractLegsModeling::addActuators()
{
