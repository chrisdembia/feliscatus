...
class TwistRigidLegsModeling : public FelisCatusModeling
{
    void addJoints();
    void addActuators();
};
...
{
    TwistRigidLegsModeling m = TwistRigidLegsModeling();
    m.makeModel("Leland_twistRigidLegs",
            "feliscatus_twistRigidLegs.osim");

    return EXIT_SUCCESS;
};

void TwistRigidLegsModeling::addJoints()
{
...
void TwistRigidLegsModeling::addActuators()
{
