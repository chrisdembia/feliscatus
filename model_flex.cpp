 ...
 * one degree-of-freedom (back flexion) joint.
 * */

class FlexModeling : public FelisCatusModeling
{
    void addJoints();
    void addActuators();
};
...
{
    FlexModeling m = FlexModeling();
    m.makeModel("Leland_flex", "feliscatus_flex.osim");

    return EXIT_SUCCESS;
};

void FlexModeling::addJoints()
{
...
void FlexModeling::addActuators()
{
