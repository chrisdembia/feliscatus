...
class FlexTwistModeling : public FelisCatusModeling
{
    void addJoints();
    void addActuators();
};
...
{
    FlexTwistModeling m = FlexTwistModeling();
    m.makeModel("Leland_flexTwist", "feliscatus_flexTwist.osim");

    return EXIT_SUCCESS;
};

void FlexTwistModeling::addJoints()
{
...
void FlexTwistModeling::addActuators()
{
