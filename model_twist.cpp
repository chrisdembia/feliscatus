 ...
 * one degree-of-freedom (spinal twist) joint.
 * */

class TwistModeling : public FelisCatusModeling
{
    void addJoints();
    void addActuators();
};
...
{
    TwistModeling m = TwistModeling();
    m.makeModel("Leland_twist", "feliscatus_twist.osim");

    return EXIT_SUCCESS;
};

void TwistModeling::addJoints()
{
...
void TwistModeling::addActuators()
{
